...
class AttentionMaskBuilder:
    def __init__(self, device: torch.device):
        ...
        self.swa_mask_restore_first = True
    ...
    def get_swa_mask(self, dtype: torch.dtype, sliding_window):
        need_restore_regen = is_restore() and self.swa_mask_restore_first
        if self.swa_mask is None or self.swa_mask.dtype != dtype or need_restore_regen:
        ...
        if need_restore_regen:
            self.swa_mask_restore_first = False
